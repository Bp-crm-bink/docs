...
<Steps>
  ...
  <Step title="Enter your credentials">
    ...
    The form validates your entries before submitting. If you leave a field empty or enter a malformed email address, an inline message appears beneath the field (for example, *Enter a valid email address*) and **Sign in** does nothing until you fix it. Use the eye icon inside the password field to toggle visibility while you type.
