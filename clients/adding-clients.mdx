...
<Steps>
  ...
  <Step title="Intake Acknowledgements">
    The client must sign five digital acknowledgement forms before submission:

    - **Marketplace Release**
    - **Enrollment & Coverage Disclosure**
    - **Income Attestation**
    - **DCF Access Authorization**
    - **FFM Consent** — Federally-Facilitated Marketplace consent. Before signing, the client must answer **Yes** or **No** to whether they consent. The answer is saved alongside the signature so you can audit who opted in or out of Marketplace assistance.
...
<Accordion title="Required fields">
  ...
  - All five intake acknowledgements signed, including a Yes/No answer on the FFM Consent form (unless using legacy bypass)
