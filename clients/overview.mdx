...
The filter bar sits above the client table. Click the **Filters** header to expand or collapse it.
...
Each active filter shows an **×** button next to it. Click it to clear that filter individually, or click **Clear all** to reset everything at once.

<Tip>
  When filters are active and the bar is collapsed, a summary of your active filters appears in the bar header so you can see what's applied at a glance.
</Tip>
