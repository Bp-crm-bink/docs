...
The profile tracks the five intake acknowledgements signed during intake — Marketplace Release, Enrollment & Coverage Disclosure, Income Attestation, DCF Access Authorization, and FFM Consent — with their signed timestamps and expiry dates. For the FFM Consent form, the client's recorded **Yes** or **No** answer is shown next to the signature. You can re-collect signatures and view the status of each form here.
