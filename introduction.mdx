...
<CardGroup cols={2}>
  ...
  <Card title="Team Messages" icon="message" href="/messages/overview">
    Chat with colleagues one-on-one or in channels without leaving the CRM. Send text, @mentions, images, and GIFs, with read receipts and unread badges.
  </Card>
</CardGroup>
