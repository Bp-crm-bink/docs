...
<Note>
  Your organization's Admins and Owners can tailor the starting layout each role sees. If your default board looks different from these examples, that's your organization's published default. See [Setting default dashboards for a role](/settings/overview#default-dashboards).
</Note>
...
<Tabs>
  ...
  <Tab title="Report">
    For the **Saved Report** widget, pick which of your saved reports the card runs. Only reports you can already see in [Reports](/reports/overview) are listed.
  </Tab>
...
<AccordionGroup>
  ...
  <Accordion title="Operations">
    ...
    - **Saved Report** — Surface a report you saved in [Reports](/reports/overview) as a card on your dashboard. It runs the report inline and shows the top rows of results right on the board, with an **Open** link to the full report. Configure the widget to point it at one of your saved reports (see [Configuring a widget](#configuring-a-widget)).
  </Accordion>
